% seedtool-cli(SECTION) | User Commands
%
% "February  6 2023"
...
seedtool-cli - program to do something

# SYNOPSIS

**seedtool-cli** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**seedtool-cli** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **seedtool-cli** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**seedtool-cli** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    seedtool-cli. See **foo.conf**(5) for further details.
...
**seedtool-cli** provides some return codes, that can be used in scripts:
